...
def send_email_for_user_sign_up(ischair, to, email_lock):
    if ischair:
        message = "You applied to register as a chair. Admins will accept or reject your application." \
                  "You are going to be notified by email soon."
        subject = "Your application to Congariser as a chair."

    else:
        message = "You applied to register as a reviewer. Admins will accept or reject your application." \
                  "You are going to be notified by email soon."
        subject = "Your application to Congariser as a reviewer."
